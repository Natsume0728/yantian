App({
  ...
  onLaunch: function () {
      ...
      var saveOpenid=true;var saveInfo=true;
      this.getUserOpenidAndSessionKey(saveOpenid, saveInfo)
  ...
  getUserInfo: function () {
    ...
    if (this.globalData.userInfo) {
      that.saveUserInfo(this.globalData.userInfo);
    } else {
      //调用登录接口
      wx.getUserInfo({
        ...
        success: function (res) {
          ...
          that.saveUserInfo(that.globalData.userInfo);
        }
      })
    }
  },
  ...
  getUserOpenidAndSessionKey: function (saveOpenid,saveInfo) {//获得用户的openid和session_key
    var that = this
                  ...
                  wx.request({//发送请求获得用户 openid
                    ...
                    success: function (res) {                                         
                      ...
                      try {//将用户openid存入缓存
                        ...
                        if(saveInfo==true)that.getUserInfo();                       
                      } catch (e) {
